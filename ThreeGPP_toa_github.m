...
method = 'TOA';            %use the time difference of arrival method
...
[~,idx] = sort(dist);
T = idx; T = reshape(T,4,2); T = T'; %sequence 
...
TB = repmat(T,n/2,1);        %transmission sequence for each of the 'n' measurements   
B = length(T);             %size of each measurment vector   
